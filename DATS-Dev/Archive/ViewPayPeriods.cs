...
{
    public partial class ViewPayPeriods : Form
    {
        public ViewPayPeriods()
        {
            InitializeComponent();
        ...
        public ViewPayPeriods(bool selectMode)
        {
            InitializeComponent();
        ...
        public int refresh()
        {
            SQL sql = new SQL(
@"SELECT
u.userid as ID, u.username as Username, u.reviewer, u.approver, u.employeeid as EmpID
